...
import './globals.css';  // Pastikan jalur ini benar
  ...
  return (
    <div className="signup-container">
      <div className="logo-container">
        <img src='/image/Journeykecil.png' alt="Logo" className="logo" />
      </div>
        ...
        <form className="signup-form">
          ...
          <div className="password-container">
            ...
            <span className="eye-icon" onClick={togglePasswordVisibility} style={{ cursor: 'pointer' }}>
              <img 
                src={showPassword ? '/symbol/View_duotone_line.svg' : '/symbol/View_hide_light.svg'} 
          ...
          <div className="password-container">
            ...
            <span className="eye-icon" onClick={toggleConfirmPasswordVisibility} style={{ cursor: 'pointer' }}>
              <img 
                src={showConfirmPassword ? '/symbol/View_duotone_line.svg' : '/symbol/View_hide_light.svg'} 
